...
void Joycon::loop() {
  ...
  this->_status.KEY1 = this->_control->ButtonPressed(MeJOYSTICK_TRIANGLE);
  this->_status.KEY2 = this->_control->ButtonPressed(MeJOYSTICK_ROUND);
  this->_status.KEY3 = this->_control->ButtonPressed(MeJOYSTICK_XSHAPED);
  this->_status.KEY4 = this->_control->ButtonPressed(MeJOYSTICK_SQUARE);
